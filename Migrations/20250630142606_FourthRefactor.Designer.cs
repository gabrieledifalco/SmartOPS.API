...
namespace SmartOPS.API.Migrations
{
    ...
    [Migration("20250630142606_FourthRefactor")]
    partial class FourthRefactor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartOPS.API.Model.MicroJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartOPS.API.Model.MicroJobResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MicroJobId");

                    b.ToTable("MicroJobResults");
                });
            ...
            modelBuilder.Entity("SmartOPS.API.Model.MicroJobResult", b =>
                {
                    b.HasOne("SmartOPS.API.Model.MicroJob", "MicroJob")
                        .WithMany()
                        .HasForeignKey("MicroJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MicroJob");
                });
